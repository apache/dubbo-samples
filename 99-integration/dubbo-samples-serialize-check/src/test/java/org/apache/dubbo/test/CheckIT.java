...
public class CheckIT {
    ...
    private static void requestOtherNotSerializable(DemoService1 demoService1) {
        ...
        try {
            demoService1.requestOtherPackageNotSerializable(notSerializable);
            Assert.fail();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    private static void returnOtherNotSerializable(DemoService1 demoService1) {
        try {
            demoService1.returnOtherPackageNotSerializable();
            Assert.fail();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    private static void requestOtherPackage(DemoService1 demoService1) {
        ...
        try {
            demoService1.requestOtherPackage(othersSerializable);
            Assert.fail();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    private static void returnOtherPackage(DemoService1 demoService1) {
        try {
            demoService1.returnOtherPackage();
            Assert.fail();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    private static void requestNotSerializable(DemoService1 demoService1) {
        ...
        try {
            demoService1.requestNotSerializable(notSerializable);
            Assert.fail();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    private static void returnNotSerializable(DemoService1 demoService1) {
        try {
            demoService1.returnNotSerializable();
            Assert.fail();
        } catch (Throwable t) {
            t.printStackTrace();
        }
