...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Process.internal_static_skywalking_v3_EBPFKubernetesProcessMetadata_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Process.internal_static_skywalking_v3_EBPFKubernetesProcessMetadata_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            EBPFKubernetesProcessMetadata.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof EBPFKubernetesProcessMetadata)) {
      return super.equals(obj);
    }
    EBPFKubernetesProcessMetadata other = (EBPFKubernetesProcessMetadata) obj;
  ...
  public static EBPFKubernetesProcessMetadata parseFrom(
  ...
  public static EBPFKubernetesProcessMetadata parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static EBPFKubernetesProcessMetadata parseFrom(
  ...
  public static EBPFKubernetesProcessMetadata parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static EBPFKubernetesProcessMetadata parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static EBPFKubernetesProcessMetadata parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(EBPFKubernetesProcessMetadata prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public EBPFKubernetesProcessMetadata getDefaultInstanceForType() {
      return EBPFKubernetesProcessMetadata.getDefaultInstance();
    }

    @Override
    public EBPFKubernetesProcessMetadata build() {
      EBPFKubernetesProcessMetadata result = buildPartial();
    ...
    @Override
    public EBPFKubernetesProcessMetadata buildPartial() {
      EBPFKubernetesProcessMetadata result = new EBPFKubernetesProcessMetadata(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof EBPFKubernetesProcessMetadata) {
        return mergeFrom((EBPFKubernetesProcessMetadata)other);
      } else {
    ...
    public Builder mergeFrom(EBPFKubernetesProcessMetadata other) {
      if (other == EBPFKubernetesProcessMetadata.getDefaultInstance()) return this;
      if (other.hasEntity()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      EBPFKubernetesProcessMetadata parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (EBPFKubernetesProcessMetadata) e.getUnfinishedMessage();
  ...
  private static final EBPFKubernetesProcessMetadata DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new EBPFKubernetesProcessMetadata();
  }

  public static EBPFKubernetesProcessMetadata getDefaultInstance() {
