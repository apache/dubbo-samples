...
VALUES
	(1, 'CreateCluster', 'dubbo-configcenter-apollo'),
	(2, 'CreateNamespace', 'dubbo-configcenter-apollo'),
	(3, 'AssignRole', 'dubbo-configcenter-apollo'),
	(4, 'ModifyNamespace', 'dubbo-configcenter-apollo+dubbo'),
	(5, 'ReleaseNamespace', 'dubbo-configcenter-apollo+dubbo');

INSERT INTO `Role` (`Id`, `RoleName`)
VALUES
	(1, 'Master+dubbo-configcenter-apollo'),
	(2, 'ModifyNamespace+dubbo-configcenter-apollo+dubbo'),
	(3, 'ReleaseNamespace+dubbo-configcenter-apollo+dubbo');
