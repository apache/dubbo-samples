# Dubbo Triple REST OpenAPI Demo

OpenAPI specification for Dubbo Triple REST demo service
...
# Deploy using Docker
docker build -t openapi-dubbo:1.0.0 .
docker run -p 8080:8080 -p 20880:20880 openapi-dubbo:1.0.0
```
