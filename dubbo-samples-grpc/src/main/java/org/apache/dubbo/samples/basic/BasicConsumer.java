...
public class BasicConsumer {
    ...
    private static RouteGuideGrpc.IRouteGuide routeGuide;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Type in any word and press `Enter` to run stream sample: ");
    ...
    public static class RouteGuideClient {
        ...
        private RouteGuideGrpc.IRouteGuide routeGuide;

        /**
         * Construct client for accessing RouteGuide server using the existing channel.
         */
        public RouteGuideClient(RouteGuideGrpc.IRouteGuide routeGuide) {
